...
var parseAmplitudeCookie = function(apiKey, newFormat) {
    ...
    try {
        for (var cookies_1 = __values(cookies), cookies_1_1 = cookies_1.next(); !cookies_1_1.done; cookies_1_1 = cookies_1.next()) {
            ...
            var _b = __read(cookie.split('=', 2), 2),
                cookieKey = _b[0],
                cookieValue = _b[1];
            if (cookieKey === key) {
    ...
    WrapperClient.prototype.request = function(request) {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/ , this.client.request(request.requestUrl, request.method, request.headers, null, request.timeoutMillis)];
                    case 1:
...
var ExperimentClient = /** @class */ (function() {
        ...
        this.config = __assign(__assign(__assign({}, Defaults), config), {
            ...
            serverUrl: (config === null || config === void 0 ? void 0 : config.serverUrl) ||
                (((_a = config === null || config === void 0 ? void 0 : config.serverZone) === null || _a === void 0 ? void 0 : _a.toLowerCase()) === 'eu' ?
                    euServerUrl :
                    Defaults.serverUrl),
            flagsServerUrl: (config === null || config === void 0 ? void 0 : config.flagsServerUrl) ||
    ...
    ExperimentClient.prototype.getUser = function() {
        ...
        if ((_a = this.user) === null || _a === void 0 ? void 0 : _a.user_properties) {
            ...
            return __assign(__assign({}, this.user), {
    ...
    ExperimentClient.prototype.setUser = function(user) {
        ...
        if ((_a = this.user) === null || _a === void 0 ? void 0 : _a.user_properties) {
            ...
            this.user = __assign(__assign({}, user), {
                user_properties: userPropertiesCopy
            });
        } else {
    ...
    ExperimentClient.prototype.doFetch = function(user, timeoutMillis, options) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_d) {
                switch (_d.label) {
                    case 0:
                        return [4 /*yield*/ , this.addContextOrWait(user)];
                    case 1:
                        user = _d.sent();
                        user = this.cleanUserPropsForFetch(user);
                        this.debug('[Experiment] Fetch variants for user: ', user);
                        return [4 /*yield*/ , this.evaluationApi.getVariants(user, __assign({
                            ...
                            user: (user === null || user === void 0 ? void 0 : user.user_id) || (user === null || user === void 0 ? void 0 : user.device_id) ?
                                {
                                    ...
                                    device_id: user === null || user === void 0 ? void 0 : user.device_id
                                } :
                                undefined,
                        })];
                    case 3:
                ...
                void this.retriesBackoff.start(function() {
                    return __awaiter(_this, void 0, void 0, function() {
                        return __generator(this, function(_a) {
                            switch (_a.label) {
                                case 0:
                                    return [4 /*yield*/ , this.fetchInternal(user, fetchBackoffTimeout, false, options)];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/ ];
                            }
    ...
    ExperimentClient.prototype.addContext = function(user) {
        ...
        return __assign(__assign(__assign(__assign({
            library: "experiment-js-client/".concat(version)
        }, providedUser), integrationUser), user), {
    ...
    ExperimentClient.prototype.addContextOrWait = function(user) {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/ , this.integrationManager.ready()];
                    case 1:
                        _a.sent();
...
var DefaultUserProvider = /** @class */ (function() {
    ...
    DefaultUserProvider.prototype.getUser = function() {
        ...
        return __assign({
            ...
            device_category: (_c = (_b = this.ua.device) === null || _b === void 0 ? void 0 : _b.type) !== null && _c !== void 0 ? _c : 'desktop',
            referring_url: (_e = (_d = this.globalScope) === null || _d === void 0 ? void 0 : _d.document) === null || _e === void 0 ? void 0 : _e.referrer.replace(/\/$/, ''),
...
var initialize = function(apiKey, config) {
    ...
    if (!instances[instanceKey]) {
        config = __assign(__assign({}, config), {
            userProvider: new DefaultUserProvider(config === null || config === void 0 ? void 0 : config.userProvider, apiKey)
        });
