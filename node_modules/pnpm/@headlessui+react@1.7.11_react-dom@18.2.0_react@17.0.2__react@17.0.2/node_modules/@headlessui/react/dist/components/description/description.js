...
function k() {
    let [n, t] = P([]);
    return [n.length > 0 ? n.join(" ") : void 0, l(() => function(e) {
        let i = v(r => (t(o => [...o, r]), () => t(o => {
                let s = o.slice(),
                    p = s.indexOf(r);
...
let S = "p",
    F = g(function(t, c) {
        let e = T(),
            {
                id: i = `headlessui-description-${e}`,
                ...a
            } = t,
            r = u(),
            o = h(c);
        E(() => r.register(i), [i, r.register]);
        let s = {
            ref: o,
            ...r.props,
            id: i
...
export {
    F as Description, k as useDescriptions
};