...
import {
    isDisabledReactIssue7711 as G
} from '../../utils/bugs.js';
import {
    OpenClosedProvider as W,
    State as b,
    useOpenClosed as $
} from '../../internal/open-closed.js';
import {
    useResolveButtonType as q
} from '../../hooks/use-resolve-button-type.js';
import {
    getOwnerDocument as z
} from '../../utils/owner.js';
import {
    useEvent as A
} from '../../hooks/use-event.js';
import {
    startTransition as J
} from '../../utils/start-transition.js';
var Q = (l => (l[l.Open = 0] = "Open", l[l.Closed = 1] = "Closed", l))(Q || {}),
...
let ee = U,
    te = k(function(n, l) {
        let {
            defaultOpen: y = !1,
            ...u
        } = n, T = R(null), t = x(l, N(a => {
            T.current = a
        }, n.as === void 0 || n.as === U)), o = R(null), f = R(null), s = j(Z, {
            disclosureState: y ? 0 : 1,
            linkedPanel: !1,
            buttonRef: f,
            panelRef: o,
            buttonId: null,
            ...
            let r = z(T);
            if (!r || !p) return;
            let c = (() => a ? a instanceof HTMLElement ? a : a.current instanceof HTMLElement ? a.current : r.getElementById(p) : r.getElementById(p))();
            c == null || c.focus()
        }), P = E(() => ({
            close: d
        }), [d]), I = E(() => ({
    ...
    le = k(function(n, l) {
        let y = _(),
            {
                id: u = `headlessui-disclosure-button-${y}`,
                ...T
            } = n,
            [t, o] = v("Disclosure.Button"),
            f = Y(),
            s = f === null ? !1 : f === t.panelId,
            i = R(null),
            p = x(i, l, s ? null : t.buttonRef);
        w(() => {
            if (!s) return o({
                type: 2,
                buttonId: u
        ...
        let D = A(r => {
                    ...
                    switch (r.key) {
                        ...
                        case m.Enter:
                            r.preventDefault(), r.stopPropagation(), o({
                                type: 0
                            }), (c = t.buttonRef.current) == null || c.focus();
                            break
                    }
                } else switch (r.key) {
                    case m.Space:
            ...
            P = A(r => {
                var c;
                G(r.currentTarget) || n.disabled || (s ? (o({
                    type: 0
                }), (c = t.buttonRef.current) == null || c.focus()) : o({
                    type: 0
                }))
            }),
            I = E(() => ({
            ...
            a = s ? {
                ...
                id: u,
                type: S,
                "aria-expanded": n.disabled ? void 0 : t.disclosureState === 0,
                "aria-controls": t.linkedPanel ? t.panelId : void 0,
                onKeyDown: D,
                onKeyUp: d,
                onClick: P
            };
    ...
    re = "div",
    oe = F.RenderStrategy | F.Static,
    se = k(function(n, l) {
        let y = _(),
            {
                id: u = `headlessui-disclosure-panel-${y}`,
                ...T
            } = n,
            [t, o] = v("Disclosure.Panel"),
            {
                close: f
            } = K("Disclosure.Panel"),
            s = x(l, t.panelRef, P => {
        ...
        let i = $(),
            p = (() => i !== null ? (i & b.Open) === b.Open : t.disclosureState === 0)(),
            D = E(() => ({
                open: t.disclosureState === 0,
                close: f
            }), [t, f]),
