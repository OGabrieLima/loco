...
import {
    forwardRefWithAs as P,
    render as R
} from '../../utils/render.js';
import {
    useIsoMorphicEffect as G
} from '../../hooks/use-iso-morphic-effect.js';
import {
    usePortalRoot as M
} from '../../internal/portal-force-root.js';
import {
    useServerHandoffComplete as C
...
function x(i) {
    let u = M(),
        ...
        e = g(i),
        [r, f] = T(() => {
            if (!u && o !== null || E.isServer) return null;
...
let _ = s,
    U = P(function(u, o) {
        let e = u,
            ...
            [l] = T(() => {
                var a;
                return E.isServer ? null : (a = n == null ? void 0 : n.createElement("div")) != null ? a : null
            }),
            b = C(),
            p = d(!1);
        return G(() => {
            if (p.current = !1, !(!t || !l)) return t.contains(l) || (l.setAttribute("data-headlessui-portal", ""), t.appendChild(l)), () => {
                p.current = !0, H(() => {
                    var a;
                    !p.current || !t || !l || (l instanceof Node && t.contains(l) && t.removeChild(l), t.childNodes.length <= 0 && ((a = t.parentElement) == null || a.removeChild(t)))
                })
            }
        }, [t, l]), b ? !t || !l ? null : y(R({
            ourProps: {
