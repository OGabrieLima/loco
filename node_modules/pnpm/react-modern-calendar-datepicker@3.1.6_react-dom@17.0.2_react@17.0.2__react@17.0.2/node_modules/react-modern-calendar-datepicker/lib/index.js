...
function b(e) {
    var t, n, a, r, o, i, c = [-61, 9, 38, 199, 426, 686, 756, 818, 1111, 1181, 1210, 1635, 2060, 2097, 2192, 2262, 2324, 2394, 2456, 3178],
        l = c.length,
        s = e + 621,
        u = -14,
        d = c[0];
...
var F = function(e) {
    ...
    t.useEffect((function() {
        ...
        return T.current.addEventListener("keyup", e, !1),
            function() {
                T.current.removeEventListener("keyup", e, !1)
            }
    }));
    var I, F = M(_).getToday,
        G = L(_),
        J = G.weekDays,
        U = G.isRtl,
        H = F(),
