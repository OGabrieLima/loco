...
const registerPlugin = videojs.registerPlugin || videojs.plugin; // Default options for the plugin.
...
const initPlugin = function(player, options) {
    ...
    reInitPlugin.getAll = () => videojs.mergeOptions(options.errors); // Get / set timeout value. Restart monitor if changed.
